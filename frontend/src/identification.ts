 ...
 */
// NOTE: this file is a synced copy of mobile/src/identification.ts (mobile is the
// source of truth). Only this JSON import path differs (desktop keeps the dataset in
// src/, mobile in assets/). `npm run check:identify-sync` fails if the logic drifts.
import mineralsData from './minerals.json'
